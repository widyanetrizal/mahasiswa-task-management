...
const QUEUE_NAME = "progress.task.updated.queue"; // nama queue yang jelas & unik
  ...
  try {
    ...
    channel.consume(QUEUE_NAME, async (msg) => {
      ...
      if (msg !== null) {
        ...
        console.log("📥 Task-service menerima update progress:", data);
        ...
        try {
          ...
          await publishLog({
            channel: "RabbitMQ",
            service: process.env.SERVICE_NAME || "class-service",
            level: "info",
            eventType: "CONSUME",
